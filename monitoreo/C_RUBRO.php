...
<hr size="1" noshade>
<form action="C_RUBRO.php" method="post">
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
...
<td><a href="C_RUBRO.php?a=reset">Quitar Filtro</a></td>
</tr>
</table>
</form>
<hr size="1" noshade>
...
<?
  ...
  foreach($fields as $val => $caption) {
?>
<td class="hr"><a class="hr" href="C_RUBRO.php?order=<? echo $val ?>&type=<? echo $ordtypestr ?>"><? echo htmlspecialchars($caption) ?></a></td>
<? } ?>
<td class="hr">&nbsp;</td>
<td class="hr">&nbsp;</td>
<td class="hr">&nbsp;</td>
...
<? } ?>
<td class="<? echo $style ?>"><a href="C_RUBRO.php?a=view&recid=<? echo $i ?>">Ver</a></td>
<td class="<? echo $style ?>"><a href="C_RUBRO.php?a=edit&recid=<? echo $i ?>">Editar</a></td>
<td class="<? echo $style ?>"><a href="C_RUBRO.php?a=del&recid=<? echo $i ?>">Borrar</a></td>
</tr>
<?
  }
...
<label>
<textarea name="DESCRIPCION_CUENTA_CONTABLE" id="textarea1" cols="50" rows="4" maxlength="500"><? echo str_replace('"', '&quot;', trim($row["DESCRIPCION_CUENTA_CONTABLE"])) ?></textarea>
</label>
<span class="textareaRequiredMsg">Obligatorio ingresar algun dato</span></span>
</td>
</tr>
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td><a href="C_RUBRO.php?a=add">Nuevo Registro</a>&nbsp;</td>
<? if ($page > 1) { ?>
<td><a href="C_RUBRO.php?page=<? echo $page - 1 ?>">&lt;&lt;&nbsp;Anterior</a>&nbsp;</td>
<? } ?>
<?
  global $pagerange;
...
<td><b><? echo $j ?></b></td>
<? } else { ?>
<td><a href="C_RUBRO.php?page=<? echo $j ?>"><? echo $j ?></a></td>
<? } } } else { ?>
<td><a href="C_RUBRO.php?page=<? echo $startpage ?>"><? echo $startpage ."..." .$count ?></a></td>
<? } } } ?>
<? if ($page < $pagecount) { ?>
<td>&nbsp;<a href="C_RUBRO.php?page=<? echo $page + 1 ?>">Siguiente&nbsp;&gt;&gt;</a>&nbsp;</td>
<? } ?>
</tr>
</table>
<? } ?>
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td><a href="C_RUBRO.php">Pagina Principal</a></td>
<? if ($recid > 0) { ?>
<td><a href="C_RUBRO.php?a=<? echo $a ?>&recid=<? echo $recid - 1 ?>">Anterior Registro</a></td>
<? } if ($recid < $count) { ?>
<td><a href="C_RUBRO.php?a=<? echo $a ?>&recid=<? echo $recid + 1 ?>">Siguiente Registro</a></td>
<? } ?>
</tr>
</table>
<hr size="1" noshade>
...
<tr>
<td><a href="C_RUBRO.php?a=add">Nuevo Registro</a></td>
<td><a href="C_RUBRO.php?a=edit&recid=<? echo $recid ?>">Editar Registro</a></td>
<td><a href="C_RUBRO.php?a=del&recid=<? echo $recid ?>">Borrar Registro</a></td>
</tr>
</table>
<?
  mssql_free_result($res);
...
function sql_select()
{
  ...
  $sql = "select
			...
			RUB.SECUENCIAL_DESPLIEGUE_RUBRO,
			RUB.GRUPO_ID,
...
function sql_insert_identity()
{
  ...
  $sql = "insert into dbo.C_RUBRO values (".sqlvalue(trim(@$_POST["NOMBRE_RUBRO"]), true) .", " .sqlvalue(trim(@$_POST["DESCRIPCION_RUBRO"]), true) .", " .sqlvalue(@$_POST["TIPO_RUBRO"], true) .", " .sqlvalue(@$_POST["SECUENCIAL_DESPLIEGUE_RUBRO"], false) .", " .sqlvalue(@$_POST["GRUPO_ID"], false) .", " .sqlvalue(@$_POST["ESTADO_ID"], false) .", " .sqlvalue(trim(@$_POST["DESCRIPCION_CUENTA_CONTABLE"]), true) .")";
  if (@mssql_query($sql, $conn) == false)
  {
    echo '<span class="Mensajes">NO SE GUARDO EL REGISTRO</span>';
    echo "<br></br>";
...
<!--
	...
	var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "real",{allowNegative:true,validateOn:["blur"], useCharacterMasking:true});
//-->
</script>
