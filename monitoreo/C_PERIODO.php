...
<hr size="1" noshade>
<form action="C_PERIODO.php" method="post">
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
...
<td><a href="C_PERIODO.php?a=reset">Quitar Filtro</a></td>
</tr>
</table>
</form>
<hr size="1" noshade>
...
<?
  ...
  foreach($fields as $val => $caption) {
?>
<td class="hr"><a class="hr" href="C_PERIODO.php?order=<? echo $val ?>&type=<? echo $ordtypestr ?>"><? echo htmlspecialchars($caption) ?></a></td>
<? } ?>
<td class="hr">&nbsp;</td>
<td class="hr">&nbsp;</td>
<td class="hr">&nbsp;</td>
...
<? } ?>
<td class="<? echo $style ?>"><a href="C_PERIODO.php?a=view&recid=<? echo $i ?>">Ver</a></td>
<td class="<? echo $style ?>"><a href="C_PERIODO.php?a=edit&recid=<? echo $i ?>">Editar</a></td>
<td class="<? echo $style ?>"><a href="C_PERIODO.php?a=del&recid=<? echo $i ?>">Borrar</a></td>
</tr>
<?
  }
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td><a href="C_PERIODO.php?a=add">Nuevo Registro</a>&nbsp;</td>
<? if ($page > 1) { ?>
<td><a href="C_PERIODO.php?page=<? echo $page - 1 ?>">&lt;&lt;&nbsp;Anterior</a>&nbsp;</td>
<? } ?>
<?
  global $pagerange;
...
<td><b><? echo $j ?></b></td>
<? } else { ?>
<td><a href="C_PERIODO.php?page=<? echo $j ?>"><? echo $j ?></a></td>
<? } } } else { ?>
<td><a href="C_PERIODO.php?page=<? echo $startpage ?>"><? echo $startpage ."..." .$count ?></a></td>
<? } } } ?>
<? if ($page < $pagecount) { ?>
<td>&nbsp;<a href="C_PERIODO.php?page=<? echo $page + 1 ?>">Siguiente&nbsp;&gt;&gt;</a>&nbsp;</td>
<? } ?>
</tr>
</table>
<? } ?>
...
<table class="bd" border="0" cellspacing="1" cellpadding="4">
<tr>
<td><a href="C_PERIODO.php">Pagina Principal</a></td>
<? if ($recid > 0) { ?>
<td><a href="C_PERIODO.php?a=<? echo $a ?>&recid=<? echo $recid - 1 ?>">Anterior Registro</a></td>
<? } if ($recid < $count) { ?>
<td><a href="C_PERIODO.php?a=<? echo $a ?>&recid=<? echo $recid + 1 ?>">Siguiente Registro</a></td>
<? } ?>
</tr>
</table>
<hr size="1" noshade>
...
<p>
<!---PRESIONA <A HREF="http:\\192.168.0.92\redireccion.html" style="color:RED" ; ><B> AQUI </B> </A>PARA CARGAR RUBROS</h6>-->
</p>
</form>
<? } ?>
...
<tr>
<td><a href="C_PERIODO.php?a=add">Nuevo Registro</a></td>
<td><a href="C_PERIODO.php?a=edit&recid=<? echo $recid ?>">Editar Registro</a></td>
<td><a href="C_PERIODO.php?a=del&recid=<? echo $recid ?>">Borrar Registro</a></td>
</tr>
</table>
<?
  mssql_free_result($res);
